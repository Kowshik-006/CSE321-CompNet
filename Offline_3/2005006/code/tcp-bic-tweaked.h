...
#ifndef TCPBICTWEAKED_H
#define TCPBICTWEAKED_H
...
class TcpBicTweaked : public TcpCongestionOps
{
  public:
    /**
     ...
     */
    TcpBicTweaked(const TcpBicTweaked& sock);
  ...
  private:
    ...
    double m_b;            //!< Binary search coefficient

    void ChangeBeta_BinCoeff();
};

} // namespace ns3
#endif // TCPBICTWEAKED_H
